...
def organization_register(request):
    if request.method == 'POST':
        ...
        try:
            ...
            AUDIT_LOG.info("Password------%s--"% password)
            AUDIT_LOG.info("Number of seats value in backend-----%s--"% number_of_seats)
            if form.is_valid():
                ...
                # password_data = User.objects.make_random_password()
                user = User(
                ...
                post.additional_seats_purchased = number_of_seats

                post.package_total_price = int(number_of_seats) * int(post.package_name.price)
                ...
                context = {
                    ...
                    'org_email': site_admin_mail,
                    'invoice': post.invoice_id,
                    'item': post.package_name,
