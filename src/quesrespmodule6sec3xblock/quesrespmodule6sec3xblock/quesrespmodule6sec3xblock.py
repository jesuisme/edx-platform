...
class QuesRespModule6Sec3XBlock(XBlock):
    """
    ...
    def student_view(self, context=None):
        """
        The primary view of the QuesRespModule6Sec3XBlock, shown to students
        when viewing courses.
        """
        html = self.resource_string("static/html/quesrespmodule6sec3xblock.html")
        frag = Fragment(html.format(self=self))
        frag.add_css(self.resource_string("static/css/quesrespmodule6sec3xblock.css"))
        ...
        frag.add_css(self.resource_string("static/css/m6s3p1.css"))
        ...
        frag.add_javascript(self.resource_string("static/js/src/quesrespmodule6sec3xblock.js"))
        ...
        frag.initialize_js('QuesRespModule6Sec3XBlock')
        return frag
    ...
    def workbench_scenarios():
        ...
        return [
            ("QuesRespModule6Sec3XBlock",
             """<quesrespmodule6sec3xblock/>
             """),
            ("Multiple QuesRespModule6Sec3XBlock",
             """<vertical_demo>
                <quesrespmodule6sec3xblock/>
                <quesrespmodule6sec3xblock/>
                <quesrespmodule6sec3xblock/>
