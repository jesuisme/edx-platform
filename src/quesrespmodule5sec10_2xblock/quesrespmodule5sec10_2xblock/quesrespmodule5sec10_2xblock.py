...
class QuesRespModule5Sec102XBlock(XBlock):
    """
    ...
    def student_view(self, context=None):
        """
        The primary view of the QuesRespModule5Sec102XBlock, shown to students
        when viewing courses.
        """
        html = self.resource_string("static/html/quesrespmodule5sec10_2xblock.html")
        frag = Fragment(html.format(self=self))
        frag.add_css(self.resource_string("static/css/quesrespmodule5sec10_2xblock.css"))
        ...
        frag.add_javascript(self.resource_string("static/js/src/quesrespmodule5sec10_2xblock.js"))
        ...
        frag.initialize_js('QuesRespModule5Sec102XBlock')
        return frag
    ...
    def workbench_scenarios():
        ...
        return [
            ("QuesRespModule5Sec102XBlock",
             """<quesrespmodule5sec10_2xblock/>
             """),
            ("Multiple QuesRespModule5Sec102XBlock",
             """<vertical_demo>
                <quesrespmodule5sec10_2xblock/>
                <quesrespmodule5sec10_2xblock/>
                <quesrespmodule5sec10_2xblock/>
