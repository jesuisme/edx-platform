...
class QuesRespModule10Sec7XBlock(XBlock):
    """
    ...
    def student_view(self, context=None):
        """
        The primary view of the QuesRespModule10Sec7XBlock, shown to students
        when viewing courses.
        """
        html = self.resource_string("static/html/quesrespmodule10sec7xblock.html")
        frag = Fragment(html.format(self=self))
        frag.add_css(self.resource_string("static/css/quesrespmodule10sec7xblock.css"))
        ...
        frag.add_css(self.resource_string("static/css/m10s7p1.css"))
        ...
        frag.add_javascript(self.resource_string("static/js/src/quesrespmodule10sec7xblock.js"))
        ...
        frag.initialize_js('QuesRespModule10Sec7XBlock')
        return frag
    ...
    def workbench_scenarios():
        ...
        return [
            ("QuesRespModule10Sec7XBlock",
             """<quesrespmodule10sec7xblock/>
             """),
            ("Multiple QuesRespModule10Sec7XBlock",
             """<vertical_demo>
                <quesrespmodule10sec7xblock/>
                <quesrespmodule10sec7xblock/>
                <quesrespmodule10sec7xblock/>
