...
class QuesRespModule3Sec7XBlock(XBlock):
    """
    ...
    def student_view(self, context=None):
        """
        The primary view of the QuesRespModule3Sec7XBlock, shown to students
        ...
        frag.add_javascript(self.resource_string("static/js/src/quesrespmodule3sec7xblock.js"))
        frag.initialize_js('QuesRespModule3Sec7XBlock')
        return frag
    ...
    def workbench_scenarios():
        ...
        return [
            ("QuesRespModule3Sec7XBlock",
             """<quesrespmodule3sec7xblock/>
             """),
            ("Multiple QuesRespModule3Sec7XBlock",
             """<vertical_demo>
                <quesrespmodule3sec7xblock/>
                <quesrespmodule3sec7xblock/>
                <quesrespmodule3sec7xblock/>
