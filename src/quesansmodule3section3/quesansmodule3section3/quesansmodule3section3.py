...
class QuesAnsModule3Section3XBlock(XBlock):
    """
    ...
    def student_view(self, context=None):
        """
        The primary view of the QuesAnsModule3Section3XBlock, shown to students
    ...
    def workbench_scenarios():
        ...
        return [
            ("QuesAnsModule3Section3XBlock",
             """<quesansmodule3section3/>
             """),
            ("Multiple QuesAnsModule3Section3XBlock",
             """<vertical_demo>
                <quesansmodule3section3/>
                <quesansmodule3section3/>
                <quesansmodule3section3/>
