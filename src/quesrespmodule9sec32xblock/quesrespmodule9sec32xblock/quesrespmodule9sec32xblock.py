...
class QUesRespModule9Sec32XBlock(XBlock):
    """
    ...
    def student_view(self, context=None):
        """
        The primary view of the QUesRespModule9Sec32XBlock, shown to students
        ...
        frag.add_javascript(self.resource_string("static/js/src/quesrespmodule9sec32xblock.js"))
        ...
        frag.initialize_js('QUesRespModule9Sec32XBlock')
        return frag
    ...
    def workbench_scenarios():
        ...
        return [
            ("QUesRespModule9Sec32XBlock",
             """<quesrespmodule9sec32xblock/>
             """),
            ("Multiple QUesRespModule9Sec32XBlock",
             """<vertical_demo>
                <quesrespmodule9sec32xblock/>
                <quesrespmodule9sec32xblock/>
                <quesrespmodule9sec32xblock/>
