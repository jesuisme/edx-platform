...
class QuesAnswModule3Sec32XBlock(XBlock):
    """
    ...
    def student_view(self, context=None):
        """
        The primary view of the QuesAnswModule3Sec32XBlock, shown to students
        ...
        frag.add_javascript(self.resource_string("static/js/src/questionanswmodule3sec32xblock.js"))
        ...
        frag.add_javascript(self.resource_string("static/js/src/questionanswmodule3sec32xblock.js"))
        frag.initialize_js('QuesAnswModule3Sec32XBlock')
        return frag
    ...
    def workbench_scenarios():
        ...
        return [
            ("QuesAnswModule3Sec32XBlock",
             """<questionanswmodule3sec32xblock/>
             """),
            ("Multiple QuesAnswModule3Sec32XBlock",
             """<vertical_demo>
                <questionanswmodule3sec32xblock/>
                <questionanswmodule3sec32xblock/>
                <questionanswmodule3sec32xblock/>
