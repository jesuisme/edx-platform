...
class QuesRespModule7Sec4XBlock(XBlock):
    """
    ...
    def student_view(self, context=None):
        """
        The primary view of the QuesRespModule7Sec4XBlock, shown to students
        when viewing courses.
        """
        html = self.resource_string("static/html/quesrespmodule7sec4xblock.html")
        frag = Fragment(html.format(self=self))

        frag.add_css(self.resource_string("static/css/quesrespmodule7sec4xblock.css"))
        ...
        frag.add_css(self.resource_string("static/css/m7s4p1.css"))
        ...
        frag.add_javascript(self.resource_string("static/js/src/quesrespmodule7sec4xblock.js"))
        ...
        frag.initialize_js('QuesRespModule7Sec4XBlock')
        return frag
    ...
    def workbench_scenarios():
        ...
        return [
            ("QuesRespModule7Sec4XBlock",
             """<quesrespmodule7sec4xblock/>
             """),
            ("Multiple QuesRespModule7Sec4XBlock",
             """<vertical_demo>
                <quesrespmodule7sec4xblock/>
                <quesrespmodule7sec4xblock/>
                <quesrespmodule7sec4xblock/>
