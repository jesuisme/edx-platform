...
class QuesRespModule9Sec3XBlock(XBlock):
    """
    ...
    def student_view(self, context=None):
        """
        The primary view of the QuesRespModule9Sec3XBlock, shown to students
        when viewing courses.
        """
        html = self.resource_string("static/html/quesrespmodule9sec3xblock.html")
        frag = Fragment(html.format(self=self))
        frag.add_css(self.resource_string("static/css/quesrespmodule9sec3xblock.css"))
        ...
        frag.add_javascript(self.resource_string("static/js/src/quesrespmodule9sec3xblock.js"))
        frag.initialize_js('QuesRespModule9Sec3XBlock')
        return frag
    ...
    def workbench_scenarios():
        ...
        return [
            ("QuesRespModule9Sec3XBlock",
             """<quesrespmodule9sec3xblock/>
             """),
            ("Multiple QuesRespModule9Sec3XBlock",
             """<vertical_demo>
                <quesrespmodule9sec3xblock/>
                <quesrespmodule9sec3xblock/>
                <quesrespmodule9sec3xblock/>
