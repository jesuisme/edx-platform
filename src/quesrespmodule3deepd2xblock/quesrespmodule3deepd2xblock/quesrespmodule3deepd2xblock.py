...
class Quesrespmodule3deep2XBlock(XBlock):
    """
    ...
    def student_view(self, context=None):
        """
        The primary view of the Quesrespmodule3deep2XBlock, shown to students
        ...
        frag.add_javascript(self.resource_string("static/js/src/quesrespmodule3deepd2xblock.js"))
        ...
        frag.initialize_js('Quesrespmodule3deep2XBlock')
        return frag
    ...
    def workbench_scenarios():
        ...
        return [
            ("Quesrespmodule3deep2XBlock",
             """<quesrespmodule3deepd2xblock/>
             """),
            ("Multiple Quesrespmodule3deep2XBlock",
             """<vertical_demo>
                <quesrespmodule3deepd2xblock/>
                <quesrespmodule3deepd2xblock/>
                <quesrespmodule3deepd2xblock/>
