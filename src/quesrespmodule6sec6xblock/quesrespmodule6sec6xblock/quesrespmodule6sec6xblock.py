...
class QuesRespModule6Sec6XBlock(XBlock):
    """
    ...
    def student_view(self, context=None):
        """
        The primary view of the QuesRespModule6Sec6XBlock, shown to students
        when viewing courses.
        """
        html = self.resource_string("static/html/quesrespmodule6sec6xblock.html")
        frag = Fragment(html.format(self=self))
        frag.add_css(self.resource_string("static/css/quesrespmodule6sec6xblock.css"))
        ...
        frag.add_css(self.resource_string("static/css/m6s6p1.css"))
        ...
        frag.add_javascript(self.resource_string("static/js/src/quesrespmodule6sec6xblock.js"))
        ...
        frag.initialize_js('QuesRespModule6Sec6XBlock')
        return frag
    ...
    def workbench_scenarios():
        ...
        return [
            ("QuesRespModule6Sec6XBlock",
             """<quesrespmodule6sec6xblock/>
             """),
            ("Multiple QuesRespModule6Sec6XBlock",
             """<vertical_demo>
                <quesrespmodule6sec6xblock/>
                <quesrespmodule6sec6xblock/>
                <quesrespmodule6sec6xblock/>
