...
class QuesRespModule5Sec4XBlock(XBlock):
    """
    ...
    def student_view(self, context=None):
        """
        The primary view of the QuesRespModule5Sec4XBlock, shown to students
        ...
        frag.add_javascript(self.resource_string("static/js/src/quesrespmodule5sec4xblock.js"))
        frag.initialize_js('QuesRespModule5Sec4XBlock')
        return frag
    ...
    def workbench_scenarios():
        ...
        return [
            ("QuesRespModule5Sec4XBlock",
             """<quesrespmodule5sec4xblock/>
             """),
            ("Multiple QuesRespModule5Sec4XBlock",
             """<vertical_demo>
                <quesrespmodule5sec4xblock/>
                <quesrespmodule5sec4xblock/>
                <quesrespmodule5sec4xblock/>
