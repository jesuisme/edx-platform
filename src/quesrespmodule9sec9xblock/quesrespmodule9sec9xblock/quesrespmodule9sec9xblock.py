...
class QuesRespModule9Sec9XBlock(XBlock):
    """
    ...
    def student_view(self, context=None):
        """
        The primary view of the QuesRespModule9Sec9XBlock, shown to students
        when viewing courses.
        """
        html = self.resource_string("static/html/quesrespmodule9sec9xblock.html")
        frag = Fragment(html.format(self=self))
        frag.add_css(self.resource_string("static/css/quesrespmodule9sec9xblock.css"))
        ...
        frag.add_css(self.resource_string("static/css/m9s9p1.css"))
        ...
        frag.add_javascript(self.resource_string("static/js/src/quesrespmodule9sec9xblock.js"))
        ...
        frag.initialize_js('QuesRespModule9Sec9XBlock')
        return frag
    ...
    def workbench_scenarios():
        ...
        return [
            ("QuesRespModule9Sec9XBlock",
             """<quesrespmodule9sec9xblock/>
             """),
            ("Multiple QuesRespModule9Sec9XBlock",
             """<vertical_demo>
                <quesrespmodule9sec9xblock/>
                <quesrespmodule9sec9xblock/>
                <quesrespmodule9sec9xblock/>
