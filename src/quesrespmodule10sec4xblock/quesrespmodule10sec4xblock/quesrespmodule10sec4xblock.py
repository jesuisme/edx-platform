...
class QuesRespModule10Sec4XBlock(XBlock):
    """
    ...
    def student_view(self, context=None):
        """
        The primary view of the QuesRespModule10Sec4XBlock, shown to students
        when viewing courses.
        """
        html = self.resource_string("static/html/quesrespmodule10sec4xblock.html")
        frag = Fragment(html.format(self=self))
        frag.add_css(self.resource_string("static/css/quesrespmodule10sec4xblock.css"))
        ...
        frag.add_css(self.resource_string("static/css/m10s4p1.css"))
        ...
        frag.add_javascript(self.resource_string("static/js/src/quesrespmodule10sec4xblock.js"))
        ...
        frag.initialize_js('QuesRespModule10Sec4XBlock')
        return frag
    ...
    def workbench_scenarios():
        ...
        return [
            ("QuesRespModule10Sec4XBlock",
             """<quesrespmodule10sec4xblock/>
             """),
            ("Multiple QuesRespModule10Sec4XBlock",
             """<vertical_demo>
                <quesrespmodule10sec4xblock/>
                <quesrespmodule10sec4xblock/>
                <quesrespmodule10sec4xblock/>
