...
def _update_course_context(request, context, course, course_key, platform_name):
    ...
    context['course_display_name_certificate'] = course.display_name
...
def _update_social_context(request, context, course, user, user_certificate, platform_name):
    ...
    share_url_facebook = "http://ut-internal-staging-native.adaptive-datamatics.com/certificates/%s" % user_certificate.verify_uuid
    context['share_url_facebook'] = share_url_facebook
